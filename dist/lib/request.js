      ...
      return new _bluebird2.default(function (resolve, reject) {
        setTimeout(function () {
          ...
          if (self.backoff.count >= _config2.default.backoff.maxNumBackoff) {
            return reject(new _error.APIError('ERR_REQUEST', 'Maximum number of backoffs reached'));
          }
          resolve();
      ...
      return new _bluebird2.default(function (resolve, reject) {
        self.sendRequest().then(function (result) {
          ...
          if (!self.options.backoff) {
            return reject(new _error.APIError('ERR_REQUEST', err.message));
          }
        ...
        (0, _request2.default)(opts, function (err, response) {
          ...
          try {
            ...
            if (response.statusCode !== 200) {
              return resolve(new _error.APIError(result.code, result.message));
            }
            resolve(result);
          } catch (err) {
